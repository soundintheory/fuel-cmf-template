...
abstract class Model
{
     ...
     * 
     * @see \Doctrine\Fuel\Model::validate()
     * @see \Doctrine\Fuel\Model::addErrorForField()
     * @see \Doctrine\Fuel\Model::getErrorsForField()
     * 
     * @var array
     */
	public $errors = array();
    ...
    {
        return \DoctrineFuel::manager()->createQueryBuilder()->select($fields)->from(get_called_class(), $alias, $indexBy);
    }
    ...
    {
        return \DoctrineFuel::manager()->getRepository(get_called_class())->find($id, $lockMode, $lockVersion);
    }
     ...
     * @return array Array of results as instances of the model
     */
    public static function findBy(array $filters, array $orderBy = array(), $limit = null, $offset = null)
    {
        $called_class = get_called_class();
    ...
    {
        return \DoctrineFuel::manager()->getRepository(get_called_class())->findOneBy($criteria);
    }
	...
	public function validate($groups = null, $fields = null, $exclude_fields = null, $exclude_types = null)
	{
	    ...
	    $result = \DoctrineFuel::validator()->validate($this, $groups);
	    $this->errors = array();
        ...
        if ($metadata->hasAssociation($field)) {
            ...
            if ($metadata->isSingleValuedAssociation($field)) {
                ...
                if (isset($association) && !$association instanceof Model)
                    throw new \InvalidArgumentException("The relation '$field' of '".get_class($this)."' is not an instance of Doctrine\Fuel\Model - this convenience method won't work!");
                ...
                if (isset($association)) \DoctrineFuel::manager()->persist($association);
    ...
    protected function completeOwningSide($field, $target_class, $target_object, $null = false)
    {
        ...
        if ($metadata->isAssociationInverseSide($field)) {
            ...
            $target_metadata = \DoctrineFuel::manager()->getClassMetadata($target_class);
    ...
    {
        return \DoctrineFuel::manager()->getRepository(get_called_class());
    }
    ...
    protected function _metadata()
    {
        ...
        //if ($called_class::$metadata === null) return $called_class::$metadata = \DoctrineFuel::manager()->getClassMetadata($called_class);
        return \DoctrineFuel::manager()->getClassMetadata($called_class);
    }
    ...
    /**
     * @see \Doctrine\Fuel\Model::$_order
    ...
    public function toArray($include_associations = true)
    {
        ...
        foreach ($metadata->associationMappings as $assoc_name => $assoc) {
            ...
            if (!is_null($value) && $value instanceof \Doctrine\Fuel\Model) $output[$assoc_name] = $value->toArray(false);
        }
